...
#define CUSTOM_MACHINE_NAME "FreedomFab"
...
//#define MESH_BED_LEVELING    // Enable mesh bed leveling.
  ...
  #define MESH_MAX_X 220 //(X_MAX_POS - MESH_MIN_X)
  #define MESH_MIN_Y 130
  #define MESH_MAX_Y 250// (Y_MAX_POS - MESH_MIN_Y)
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define FRONT_PROBE_BED_POSITION 115
    #define BACK_PROBE_BED_POSITION 267
    ...
    #define AUTO_BED_LEVELING_GRID_POINTS 3
      ...
      #define ABL_PROBE_PT_1_X 255
      #define ABL_PROBE_PT_1_Y 97
      #define ABL_PROBE_PT_2_X 75
      #define ABL_PROBE_PT_2_Y 92
      #define ABL_PROBE_PT_3_X 248
      #define ABL_PROBE_PT_3_Y 298
...
#define PLA_PREHEAT_HPB_TEMP 71
